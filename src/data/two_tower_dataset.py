...
class NextItemDataset(Dataset):
    """One example per training prefix, predicting its immediate next item.

    The final two interactions are held out. Prefixes longer than max_len
    retain their latest max_len items; negatives are resampled each epoch.
    """
